...
export default function RestaurantLogin() {
  ...
  const handleLogin = async () => {
    const { restaurantID, password } = formData;
    ...
    try {
      ...
      // Save restaurant details in localStorage
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FAD961] to-[#F76B1C] text-gray-900 flex flex-col items-center p-6">
      ...
      <p className="text-lg text-gray-800 text-center mt-2 max-w-xl">Enter your credentials to access your restaurant dashboard.</p>
